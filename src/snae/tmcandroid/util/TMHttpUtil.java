...
public class TMHttpUtil {
    ...
    public static String getContentFromGetURL(String strUrl) {
        try {
            Log.d(TAG, "getContentFromGetURL:" + strUrl);
    ...
    public static String getContentFromPostURL(String strUrl, String query) {
        try {
            Log.d(TAG, "getContentFromPostURL:" + strUrl + " query:" + query);
